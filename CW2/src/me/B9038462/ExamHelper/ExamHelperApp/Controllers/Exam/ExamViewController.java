...
import me.B9038462.ExamHelper.ExamHelperApp.Controllers.ExamResult.ExamResultViewController;
...
import me.B9038462.ExamHelper.ExamHelperApp.Repositories.ExamRepository.ExamRepository;
...
//        //table.getSelectionModel().selectedItemProperty().get();
    ...
    public void createExam(ActionEvent actionEvent) {
        try {
            ...
            fxmlLoader.setLocation(getClass().getClassLoader().getResource("me/B9038462/ExamHelper/ExamHelperApp/Views/Exam/create.fxml"));
    ...
    public void startExam(ActionEvent actionEvent) {
        ...
        if (exam != null) {
            try {
                ...
                loader.setLocation(getClass().getClassLoader().getResource("me/B9038462/ExamHelper/ExamHelperApp/Views/Exam/main.fxml"));
    ...
    public void viewExamResult(ActionEvent actionEvent) {
        ...
        if (exam != null) {
            try {
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getClassLoader().getResource("me/B9038462/ExamHelper/ExamHelperApp/Views/ExamResult/view.fxml"));
